        ...
        return (
          <div className="general-div" key={advertDetail.id}>
            <div className="left-div">
              <div className="left-title-desc-div">
                {advertDetail.advertDesc}
              </div>
            ...
            <div className="bottom-advert-desc">
              ...
              voluptas rerum. Delectus veritatis soluta ad maxime dolore omnis
              quas dolorem nemo pariatur! Atque consectetur tempora neque esse
              porro quidem!
            </div>
